...
// Hero banner configurations for different pages
export const heroBannerConfigs = {
  campaign: {
    backgroundImage: getImagePath("/images/banners/campaign-header.jpg"),
    title: "ᠪᠢᠳᠡ ᠶᠠᠭᠤᠮ ᠬᠢᠵᠤ ᠪᠠᠶᠢᠨ᠎ᠠ?",
    description:
      "Бид шударга бус явдалтай тэмцэж, хүний эрхийг хөхүүлэн дэмжих дэлхий нийтийн хөдөлгөөн юм.",
  },
  news: {
    backgroundImage: getImagePath("/images/news/header-img.jpg"),
    title: "ᠮᠡᠳᠡᠭᠡ ᠮᠡᠳᠡᠭᠦᠯᠡᠯ",
  },
  about: {
    backgroundImage: getImagePath("/images/about/header-img.jpg"),
    title: "ᠪᠢᠳᠡᠨᠢ ᠲᠤᠬᠠᠢ",
  },
  donation: {
    backgroundImage: getImagePath("/images/donate/header-img-donation.jpg"),
  ...
  participation: {
    backgroundImage: getImagePath("/images/participation/header-img.png"),
    title: "ᠲᠠᠨ ᠤ ᠣᠷᠣᠯᠴᠠᠭᠠᠨ",
  },
  right: {
    backgroundImage: getImagePath("/images/banners/campaign-header.jpg"), // reusing campaign image as placeholder
    title: "ᠬᠦᠮᠦᠨ ᠦ ᠡᠷᠬᠡ",
  },
  member: {
    backgroundImage: getImagePath("/images/members/header-img.jpg"),
    title: "ᠭᠢᠰᠦᠨᠴᠢᠯᠡᠯ",
  },
  shop: {
    backgroundImage: getImagePath("/images/banners/campaign-header.jpg"), // reusing campaign image as placeholder
...
// Specific campaign page banners (can be extended)
