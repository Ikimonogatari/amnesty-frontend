    ...
    <Layout>
      ...
      <div className="h-full hidden sm:flex gap-20 w-auto flex-shrink-0">
        ...
        <div className="h-full p-4 flex gap-10">
          ...
          >
            ᠮᠣᠩᠭᠣᠯ ᠤᠯᠤᠰ ᠤᠨ ᠡᠮᠨᠧᠰᠲᠢ ᠢᠨᠲᠧᠷᠨᠡᠰᠢᠨᠯ ᠨᠢ ᠲᠠᠨᠢ ᠨᠢᠭᠤᠴᠠ ᠶᠢᠨ ᠬᠠᠮᠠᠭᠠᠯᠠᠯ ᠢ
            ᠠᠰᠢᠭᠯᠠᠨ ᠬᠠᠷᠢᠭᠤᠯᠬᠤ ᠪᠣᠯᠤᠨ ᠲᠠᠨᠢ ᠬᠤᠪᠢ ᠶᠢᠨ ᠮᠡᠳᠡᠭᠡ ᠮᠡᠳᠡᠯᠭᠡ ᠶᠢ ᠬᠠᠮᠠᠭᠠᠯᠠᠬᠤ
            ᠨᠢ ᠪᠢᠳᠡ ᠳᠡᠭᠦ ᠨᠢᠭᠤᠴᠠ ᠶᠢᠨ ᠪᠣᠳᠣᠯᠭᠠ ᠳᠤ ᠬᠤᠪᠢᠶᠠᠨ ᠠᠮᠤᠷ ᠬᠣᠩᠴᠢ ᠨᠡᠷᠡ ᠲᠡᠢ
            ᠦᠢᠯᠡᠳᠦᠯ ᠢ ᠵᠢᠷᠢᠭᠯᠡᠨᠡ᠃ ᠪᠢᠳᠡ ᠲᠠᠨᠢ ᠨᠡᠷᠡ᠂ ᠢᠮᠡᠶᠢᠯ ᠬᠠᠶᠠᠭ᠂ ᠤᠲᠠᠰᠤᠨ ᠬᠠᠶᠠᠭ᠂
            ᠬᠤᠪᠢ ᠶᠢᠨ ᠮᠡᠳᠡᠭᠡ ᠮᠡᠳᠡᠯᠭᠡ ᠪᠣᠯᠤᠨ ᠪᠤᠰᠤᠳ ᠨᠢᠭᠤᠴᠠ ᠮᠡᠳᠡᠭᠡ ᠶᠢ ᠬᠤᠷᠢᠶᠠᠵᠤ
            ᠪᠠᠢᠢᠭᠠ᠃
          </p>
        </div>
        <div className="min-w-[20rem] py-4 px-14 bg-[#F1F1F1] flex gap-7">
          ...
          >
            ...
            ᠰᠢᠢᠳᠪᠦᠷᠢ᠂ ᠦᠢᠯᠡᠴᠢᠯᠡᠯᠳᠦ ᠶᠢᠨ ᠰᠠᠢᠵᠢᠷᠠᠭᠤᠯᠭᠠ ᠪᠣᠯᠣᠨ ᠪᠤᠰᠤᠳ ᠤᠷᠠᠯᠭᠠ ᠬᠣᠶᠠᠷ
            ᠢᠯᠭᠡᠡᠬᠦ ᠪᠣᠯᠣᠨ ᠠᠮᠠᠷᠠ ᠶᠠᠪᠳᠠᠯ ᠤᠨ ᠲᠤᠯᠠ ᠠᠰᠢᠭᠯᠠᠵᠤ ᠪᠣᠯᠣᠨᠠ᠃
          </p>
        </div>
        <div className="flex gap-12 p-4 h-full">
          ...
          >
            ...
            ᠲᠠᠨᠢ ᠮᠡᠳᠡᠭᠡ ᠮᠡᠳᠡᠯᠭᠡ ᠶᠢ ᠭᠠᠵᠠᠷ ᠪᠦᠯᠦᠭ ᠦᠨ ᠬᠦᠮᠦᠨ ᠳᠦ ᠦᠯᠦ ᠬᠤᠪᠢᠶᠠᠨᠠ ᠪᠣᠯᠤᠨ
            ᠡᠨᠡ ᠮᠡᠳᠡᠭᠡ ᠮᠡᠳᠡᠯᠭᠡ ᠶᠢ ᠳᠤᠷᠠᠷᠠ ᠬᠠᠮᠠᠭᠠᠯᠠᠭᠰᠠᠨ ᠦᠭᠡᠢ᠃
          </p>
        </div>
        ...
        <div className="px-3 py-2">
          <div className="flex gap-2 max-h-[110px] overflow-x-auto">
            ...
            >
              ...
              ᠤᠨ ᠰᠢᠢᠳᠪᠦᠷᠢ᠂ ᠦᠢᠯᠡᠴᠢᠯᠡᠯᠳᠦ ᠶᠢᠨ ᠰᠠᠢᠵᠢᠷᠠᠭᠤᠯᠭᠠ ᠪᠣᠯᠣᠨ ᠪᠤᠰᠤᠳ ᠤᠷᠠᠯᠭᠠ ᠬᠣᠶᠠᠷ
              ᠢᠯᠭᠡᠡᠬᠦ ᠪᠣᠯᠣᠨ ᠠᠮᠠᠷᠠ ᠶᠠᠪᠳᠠᠯ ᠤᠨ ᠲᠤᠯᠠ ᠠᠰᠢᠭᠯᠠᠵᠤ ᠪᠣᠯᠣᠨᠠ᠃
            </p>
          </div>
        </div>
