// Next.js API route to proxy reset password verify requests to avoid CORS issues
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${userApiUrl}/auth/resetPassVerify`, {
      method: "POST",
      headers,
    ...
    console.error("Reset password verify proxy error:", error);
