// Next.js API route to proxy /users/events/list requests to avoid CORS issues
export default async function handler(req, res) {
  ...
  try {
    ...
    const response = await fetch(`${userApiUrl}/events/list`, {
      method: "GET",
      headers,
    });
    ...
    console.log("=== USER EVENTS PROXY SUCCESS ===");
