    ...
    <Html lang="mn">
      <Head>
        ...
        <link
          ...
          sizes="180x180"
          href="/mng/favicon/apple-touch-icon.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
          href="/mng/favicon/favicon-32x32.png"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="/mng/favicon/favicon-16x16.png"
        />
        <link rel="shortcut icon" href="/mng/favicon/favicon-32x32.png" />
        <link rel="manifest" href="/mng/favicon/site.webmanifest" />
