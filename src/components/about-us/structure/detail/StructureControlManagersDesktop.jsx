...
export default function StructureControlManagersDesktop() {
  ...
  const controlManagers = [
    {
      ...
      image: getImagePath("/images/control-managers/todrol.png"),
    },
    {
      id: 2,
      name: "ᠰ‍᠂ᠨᠠᠵᠢᠳᠮ᠎ᠠ᠃",
      ...
      image: getImagePath("/images/control-managers/najidmaa.png"),
    },
    {
      id: 3,
      name: "ᠮ‍᠂ᠴᠢᠮᠡᢉ ᠡ",
      ...
      image: getImagePath("/images/control-managers/chimge.png"),
    },
  ];
  ...
  return (
    <div className="h-full hidden sm:flex gap-20 overflow-x-auto w-auto flex-shrink-0 max-h-screen sm:overflow-y-hidden min-w-screen">
      <StaticHeader
        image="/images/aboutSub1/managers/header-img.png"
