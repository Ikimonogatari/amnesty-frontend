...
export default function GiftMobile() {
    ...
    <div className="w-full min-h-screen bg-white md:hidden">
      ...
      <div className="flex flex-col gap-4 p-4 overflow-x-auto">
        <div className="flex-shrink-0">
          <Image
            src="/mng/images/donate/gift/img1.png"
            alt="Gift Image"
            width={500}
            height={100}
        ...
        {/* Added h-[400px] to force wrapping and leading-loose to spread columns */}
        <div className="w-full flex-shrink-0">
          <p 
            className="text-xs leading-loose text-justify" 
            style={{ 
              writingMode: "vertical-lr",
              height: "200px", // Constraining height forces the text to create more columns horizontally
              width: "100%" 
            }}
          >
      ...
      {/* Examples Section */}
      <div className="bg-[#ECECEC] flex gap-4 p-4 overflow-x-auto">
        <h3 className="text-sm font-bold flex-shrink-0" style={{ writingMode: "vertical-lr" }}>
          ᠵᠢᠱᠢᠶ᠎ᠡ ᠨᠢ:
        </h3>
        {exampleItems.map((item, index) => (
          <div key={index} className="h-[200px] flex items-start gap-2 flex-shrink-0">
            <p className="text-xs" style={{ writingMode: "vertical-lr" }}>
              {item}
            </p>
          </div>
        ))}
      ...
      <div className="p-4 overflow-x-auto">
        <p className="text-xs h-[150px]" style={{ writingMode: "vertical-lr" }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex gap-2">
                ...
                render={({ field }) => (
                  <div className="relative dropdown-container">
                    <button
                      ...
                      className="border border-gray-300 rounded-md p-2 w-16 h-[300px] text-xs bg-white flex flex-col items-center justify-center gap-2"
                      style={{ writingMode: "vertical-lr" }}
                    >
                    ...
                    {isDropdownOpen && (
                      <div className="absolute top-0 left-20 bg-white border border-gray-300 rounded-md shadow-lg z-10 flex h-[300px]">
            ...
            <div className="flex gap-2">
              <div className="flex flex-col gap-1">
                ...
                <p
                  ...
                  style={{ writingMode: "vertical-lr" }}
                >
                  ᠬᠠᠮᠤᠭ ᠤ᠋ᠨ ᠢᢈᠡ ᠳ᠋ᠡᠭᠡᠨ ᠑᠐᠐᠐ ᠲᠡᠮᠳᠡᠭᠲᠦ ({messageValue.length}/1000)
                </p>
              </div>
              <textarea
                {...register("message", {
            ...
            <div className="flex gap-2">
              <button
                ...
                style={{ writingMode: "vertical-lr", width: "48px" }}
              >
      ...
      {/* Quote Section */}
      <div className="bg-[#ECECEC] flex gap-8 p-4 m-4">
        <h5 className="h-[150px] text-sm font-bold" style={{ writingMode: "vertical-lr" }}>
