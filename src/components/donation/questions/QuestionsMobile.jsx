  ...
  return (
    <div className="w-full min-h-screen bg-white md:hidden">
      ...
      <div className="space-y-4">
        <div className="bg-[#ECECEC] flex gap-4 p-6 overflow-x-auto">
          <h5 className="text-xl font-bold flex-shrink-0 max-h-[300px]" style={{ writingMode: "vertical-lr" }}>
            ᠮᠢᠨᠤ ᠲᠥᠯᠦᢉᠰᠡᠨ ᠬᠠᠨᠳᠢᠪ ᢈᠡᠷᢈᠢᠨ ᠵᠠᠷᠤᠴᠠᠭᠤᠯᠤᠭᠳᠠᠳᠠᠭ ᠪᠤᠢ?
          </h5>
          <p className="text-sm flex-1 max-h-[300px]" style={{ writingMode: "vertical-lr" }}>
        ...
        <div className="bg-white flex gap-4 p-6 overflow-x-auto">
          <h5 className="text-xl font-bold flex-shrink-0 max-h-[300px]" style={{ writingMode: "vertical-lr" }}>
        ...
        <div className="bg-[#ECECEC] flex gap-4 p-6 overflow-x-auto">
          ...
          <p className="text-sm flex-1 max-h-[300px]" style={{ writingMode: "vertical-lr" }}>
            ᠲᠠ ᠗᠐᠂᠐᠐᠐₮ ᢈᠦᠷᠲᠡᠯᠡᢈᠢ ᠦᠨ᠎ᠡ ᠶ᠋ᠢᠨ ᠳ᠋ᠦᠩᠲᠡᠢ ᠬᠠᠨᠳᠢᠪ ᠥᢉᢈᠦ ᠪᠣᠯ ᠰᠢᠭᠤᠳ ᠬᠠᠨᠳᠢᠪ ᠥᢉᢈᠦ ᠰᠤᠪᠠᠭ ᠢ᠋ᠶᠠᠷ ᠳᠠᠮᠵᠢᠭᠤᠯᠤᠨ ᠢᠯᠡᢉᠡᢈᠦ ᠪᠣᠯᠤᠮᠵᠢ ᠲᠠᠢ᠃  
        ...
        <div className="bg-[#fcff5d] flex gap-4 p-6 overflow-x-auto">
          <h5 className="text-xl font-bold flex-shrink-0 max-h-[300px]" style={{ writingMode: "vertical-lr" }}>
          ...
          <div 
            className="border border-black p-4 rounded-lg h-32 w-12 cursor-pointer flex items-center justify-center hover:bg-yellow-200 transition-colors mt-4"
