...
export default function DonateFloatingButton() {
  ...
  return (
    <div className="donate-floating-button relative">
      <div
        className="sub relative h-[160px] cursor-pointer select-none !overflow-visible"
        onClick={handleClick}
      >
        <div className="relative mt-8">
          <div className="candle absolute ml-[13px] h-full w-full">
            <div className="candle-flame relative">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 12.5 24.978"
                style={{ height: "25px", width: "15px" }}
                className="fire-big-svg absolute"
              >
                <g data-name="Layer 2">
                  <g data-name="flame b" className="h-[25px] w-[15px]">
                    <path
                      className="fire-big-svg transition-all"
                      d="M0 15.157c0 6.897 6.25 9.821 6.25 9.821s6.25-2.924 6.25-9.821S6.25 0 6.25 0 0 8.26 0 15.157z"
                      style={{ fill: "#ff4700" }}
                    />
                  </g>
                </g>
              ...
              <svg
                className="fire-small-svg absolute"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 12.5 24.978"
                style={{ height: "25px", width: "15px" }}
              >
                <g data-name="Layer 2">
                  <g data-name="flame b" className="h-[25px] w-[15px]">
                    <path
                      className="fire-small-svg w-[15px]"
                      d="M3.375 18.383a6.768 6.768 0 0 0 2.875 5.763 6.768 6.768 0 0 0 2.875-5.763c0-4.047-2.875-8.893-2.875-8.893s-2.875 4.846-2.875 8.893z"
                      style={{ fill: "#ffbf00" }}
                    />
                  </g>
                </g>
