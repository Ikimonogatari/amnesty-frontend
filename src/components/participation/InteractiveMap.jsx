...
const InteractiveMap = () => {
  ...
  const findCoordinatedProvinces = () => {
    return provinces;
  };

  const findProvinceByName = (name) => {
    const province = provinces.find((p) => p.title === name);
    return province ? province.id : null;
  };

  const hoverIn = (provinceName) => {
    const provinceId = findProvinceByName(provinceName);
  ...
  const navigateToDetails = (provinceTitle) => {
    // Navigate to province details page
    window.location.href = `/participation/humanrighteye/details?province=${encodeURIComponent(
      provinceTitle
    )}`;
  };

  const fillInfo = (provinceId) => {
    // Scroll to form section
    const element = document.getElementById("fill-info");
    if (element) {
    ...
    <div className="relative">
      <div className="relative">
        ...
        >
          ...
          {/* Add more province paths here - continuing with the rest */}
          <path
            ...
            id="MNG3315"
            name="Hentiy"
            onMouseOver={() => hoverIn("ᠦᠪᠦᠷ ᠬᠠᠩᠭᠠᠢ")}
            fill={
              hoveredProvinceId === findProvinceByName("ᠦᠪᠦᠷ ᠬᠠᠩᠭᠠᠢ")
                ? "#ffff00"
                : "#fff"
            }
            stroke="#000"
          ...
          />
          <path
            d="M521.7 149.1l0.3 1.2 1 1.8 0.3 0.7 0 0.7-0.2 0.7-0.5 0.5-1 1.1-1.4 1.2-2.9 1.8-1.3-0.6-1.1-0.8-1.8-0.8-1.8-0.3-5.7-1.6 0-2.6 1.9-2.6 1.3-1.2 1.1 0.5 4.5 1.4 1.8-1.8 1.1-0.5 0.8-0.1 1.3 0.2 0.8 0.3 1.5 0.8z"
            id="MNG3324"
            name="Orhon"
            onMouseOver={() => hoverIn("ᠣᠷᠬᠣᠨ")}
            fill={
              hoveredProvinceId === findProvinceByName("ᠣᠷᠬᠣᠨ")
                ? "#ffff00"
                : "#fff"
            }
            stroke="#000"
          ...
          />
          <path
            d="M644.7 204.9l-0.1 0.7-0.5 0.9-0.2 0.5 0.4 1.9 0 0.6 0 1.4 0.2 0.5 0.5 0.7-0.2 0.7-0.1 1.5-0.2 0.8-1.1 2.2-0.9 0.8-0.1 0.4 0.1 0.6 0.4 0.7 0.1 0.5 0 1.1-3.9-0.7-0.7-0.3-0.6-0.5-1-1.5-0.3-1.9-0.6-1.9-0.1-0.9 0.1-1.2 0.4-1.5 0.7-2 0.5-0.8 0.9-1.3 2.2-2.2 4.1 0.2z"
            id="MNG3330"
            name="Govĭ-Sümber"
            onMouseOver={() => hoverIn("ᠭᠣᠪᠢ ᠰᠦᠮᠪᠡᠷ")}
            fill={
              hoveredProvinceId === findProvinceByName("ᠭᠣᠪᠢ ᠰᠦᠮᠪᠡᠷ")
                ? "#ffff00"
                : "#fff"
            }
            stroke="#000"
          ...
          />
          <path
            d="M594.3 192.8l0.7 0.1 1.1-0.1 2.6-0.8 3-1.3 0.9 1.7 0.6 1.2 1.6 1.9 1.9 3.2 0.9 1 0.8 1.1 0.6 0.6 0.6 0.6 0.7 0.4 0.8 0.2 2 0.4 2 0.8 0.8 0.5 0.5 0.6 0.2 0.7 0 0.8-0.8 3-0.3 2.2-0.9 4.3-0.1 1.1-1.6 0.5-1.4 0.2-2.4 0.1-1.9-0.2-0.8-0.3-0.8-0.4-2.4-2.1-1.1-0.8-1.2-0.5-1.2-0.2-2.4-0.1-0.8 0-3.6 0.6-4.7 0.5-1-0.5-2.6-0.6-0.8-0.5-0.2-0.3-0.3-0.8-0.2-0.8 0-3.6-0.4-1.6-0.5-1.4-0.4-0.7-0.8-1-0.3-6.1-0.9-3.1-0.5-2.2-0.6-2.1 7.3 1.4 3.1 0.8 2.6 0.5 0.8 0.3 1.8 0.8z"
            id="MNG3331"
            name="Ulaanbaatar"
            onMouseOver={() => hoverIn("ᠤᠯᠠᠭᠠᠨᠪᠠᠭᠠᠲᠤᠷ")}
            fill={
              hoveredProvinceId === findProvinceByName("ᠤᠯᠠᠭᠠᠨᠪᠠᠭᠠᠲᠤᠷ")
                ? "#ffff00"
                : "#fff"
            }
            stroke="#000"
        ...
        {coordinatedProvinces.map((province) => (
          <div
            key={province.id}
            className="absolute"
            style={{
              top: `${province.y}px`,
              left: `${province.x}px`,
              flexDirection: province.title.includes("ᠣᠷᠬᠣᠨ")
                ? "row-reverse"
                : "row",
            }}
          >
            <div className="flex">
              <div
                ...
                style={{
                  width: `${province.width}px`,
                  height: `${province.height}px`,
                }}
              />
              <div>
