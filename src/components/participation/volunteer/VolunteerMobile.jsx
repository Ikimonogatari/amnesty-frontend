    ...
    <div className="h-full w-full block sm:hidden p-4">
      ...
      <div className="flex flex-col gap-7">
        {volunteerItems.map((item) => (
          <div
            key={item.id}
            className="flex gap-3 w-full max-h-[180px] overflow-x-auto"
          >
            {item.title && (
              <p
                className="text-[10px] font-bold bg-[#FFFF00] py-3 flex justify-center items-center text-center pl-2 h-full w-12"
                style={{
